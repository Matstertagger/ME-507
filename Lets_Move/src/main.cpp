/** @file main.cpp
 *    This file contains a program that runs a motor.
 *    Outputs PWM signal to A3 which connects to motor driver board
 *    User can run motor forward or backwards by chaning line 144
 *    
 *
 *  @author  John Ridgeley
...
void task_ui (void* p_params)
{
    ...
    for (;;)
    {
        ...
        if(number > 255 || number < 0){
          Serial << "Cmon bro, I said a number between 0 and 255." << endl << endl;
          //Serial << endl;
        }
...
void task_sim (void* p_params)
{
    ...
    for (;;)
    {
        ...
        //modify to run motor in forward or reverse direction
        pinMode (A5, OUTPUT);
